/**  $Id: individual.h,v 1.9 2015-07-13 08:52:58 fred Exp $
*
*  @file individual.h
*  Nemo2
*
...
private:
  ...
  sex_t _sex;
  /**Parents ID tags.*/
  unsigned long _motherID, _fatherID;
  /**Parents pointers.*/
...
public:
  ...
  void            Aging                  ()                     {_age++;}
  void            setFatherID            (unsigned long value)  {_fatherID = value;}
  ...
  unsigned long   getFatherID            ()                      {return _fatherID;}
