/** $Id: statservices.h,v 1.12 2015-07-13 08:52:57 fred Exp $
*
*  @file statservices.h
*  Nemo2
*
...
public:
  ...
  _numRecorders(0), _width(12), _precision(6), _separator('\t'), _printAverages(1)
  { }
  ...
  void setDefaultOutputFormat   () {_width = 12; _precision = 6; _separator = '\t';}
