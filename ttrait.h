/**  $Id: ttrait.h,v 1.10 2016-03-03 15:19:18 fred Exp $
*
*  @file ttrait.h
*  Nemo2
*
...
public:
  ...
  /** Called to change the allelic value at a particular locus
    * @param locus the targeted locus
    * @param alele the targeted allele
    * @param value the value of the allele inserted
   **/
