/**  $Id: Uniform.h,v 1.13 2016-10-31 14:35:39 fred Exp $
*
*  @file Uniform.h
*  Nemo2
*
...
//  }
  ...
  static inline void Sample (int from, int to, unsigned int num, int* result, bool replace)
  {
	  assert(from < to);
	  ...
	  for(unsigned int i = 1; seq[i-1] < to && i < seq_length; ++i) seq[i] = seq[i-1] + 1;
